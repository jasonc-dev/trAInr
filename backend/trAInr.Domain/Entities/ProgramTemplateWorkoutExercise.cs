...
/// <summary>
///     Represents an exercise instance within a program template workout day
///     Links an exercise template to a specific workout with planned sets
/// </summary>
public class ProgramTemplateWorkoutExercise
{
    ...
    public ProgramTemplateWorkoutDay ProgramTemplateWorkoutDay { get; set; } = null!;
